var animals = [];
    function createAnimals() {
        ...
        var bear = {
            ...
            legsNum: "They have 4 legs.",
            funFact: "They can run up to 40 mph despite their size and are less dangerous than men."
        }
        ...
        var chimpanzee = {
            ...
            speciesCount: "1 species is currently recognized.",
            legsNum: "They have 2 legs.",
            funFact: "They share about 98.8% of their DNA with humans."
        }
        ...
        var jellyfish = {
            ...
            lifespan: "They live for several months to several years, depending on the species, or even in one case, forever.",
            diet: "They are carnivores.",
        ...
        var worm = {
            ...
            diet: "They are detritivores (feeds on dead organic material).",
            dimorphism: "Males and females are similar in appearance.",
            speciesCount: "Over 6,000 species are currently recognized.",
            legsNum: "They have no legs.",
        ...
        var crane = {
            ...
            color: "They are typically gray or white.",
            lifespan: "They live for 20-30 years in the wild.",
        ...
        var crow = {
            ...
            color: "They are typically black and glossy.",
            lifespan: "They live for 7-8 years in the wild.",
        ...
        var raven = {
            ...
            color: "They are typically black.",
            lifespan: "They live for 10-15 years in the wild.",
        ...
        var peacock = {
            ...
            color: "They are colorful with iridescent blues and greens.",
            lifespan: "They live for 10-20 years in the wild.",
            diet: "They are omnivores, feeding on insects, plants, and small reptiles.",
            dimorphism: "Males are larger and have more elaborate and more colorful plumage than females.",
            speciesCount: "3 species are currently recognized.",
            legsNum: "They have 2 legs.",
        ...
        var duck = {
            ...
            color: "They have varied colors including brown, white, and green.",
        ...
        var human = {
            class: "They are mammals.",
            weight: "Adults vary widely in weight depending on age, gender, and health, weighing anywhere from 100-250 pounds.",
            ...
            lifespan: "They live 60-90 years or more, depending on where they are globally.",
            ...
            speciesCount: "1 species is currently recognized.",
            legsNum: "They have 2 legs.",
            funFact: "They have developed complex languages, societies, and technologies, distinguishing them from other species."
        }
        ...
        var pigeon = {
            ...
            color: "They are typically gray and iridescent on their neck.",
            lifespan: "They live for 3-5 years in the wild.",
            diet: "They are omnivores, eating seeds, grains, and insects.",
            dimorphism: "Males and females are similar in size and coloration.",
            speciesCount: "Over 300 species are currently recognized.",
            legsNum: "They have 2 legs.",
            funFact: "They are the only once domesticated animal to be no longer domesticated by humans."
        }
        ...
        var axolotl = {
            class: "They are amphibians.",
            weight: "Adults weigh around 2-8 ounces.",
            geography: "They are found in Mexico.",
            biome: "They live in freshwater lakes and canals.",
            color: "They are typically pale pink or brown.",
            lifespan: "They live for 10-15 years in captivity.",
            diet: "They are carnivores, feeding on worms, insects, and small fish.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "1 species is currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They are known for their ability to regenerate lost limbs and other body parts."
        }
        animals.push(["Axolotl", axolotl]);

        var seagull = {
            class: "They are birds.",
            weight: "Adults weigh between 0.5-3 pounds.",
            geography: "They are found worldwide, especially in coastal areas.",
            biome: "They live in coastal areas and near large bodies of water.",
            color: "They are typically white with grey or black wings.",
            lifespan: "They live for 10-20 years in the wild.",
            diet: "They are omnivores, feeding on fish, insects, and human food scraps.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "54 species are currently recognized.",
            legsNum: "They have 2 legs.",
            funFact: "They are known for their loud calls and scavenging behavior."
        }
        animals.push(["Seagull", seagull]);

        var hamster = {
            class: "They are mammals.",
            weight: "Adults weigh around 1-4 ounces.",
            geography: "They are found in Europe and Asia, commonly kept as pets worldwide.",
            biome: "They live in deserts, grasslands, and agricultural areas.",
            color: "They are typically brown, black, white, or a mix of these colors.",
            lifespan: "They live for 2-3 years in captivity.",
            diet: "They are omnivores, feeding on seeds, fruits, and insects.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "18 species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They have cheek pouches that they use to carry food."
        }
        animals.push(["Hamster", hamster]);

        var turtle = {
            class: "They are reptiles.",
            weight: "Adults weigh between 5-500 pounds depending on the species.",
            geography: "They are found worldwide, particularly in tropical and subtropical regions.",
            biome: "They live in freshwater and marine environments.",
            color: "They are typically green, brown, or grey.",
            lifespan: "They live for 20-100+ years depending on the species.",
            diet: "They are omnivores, feeding on plants, insects, and small fish.",
            dimorphism: "Males often have longer tails and concave plastrons.",
            speciesCount: "356 species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They have shells that provide protection from predators."
        }
        animals.push(["Turtle", turtle]);

        var tortoise = {
            class: "They are reptiles.",
            weight: "Adults weigh between 2-400 pounds depending on the species.",
            geography: "They are found in Africa, Asia, the Americas, and some islands.",
            biome: "They live in deserts, grasslands, and forests.",
            color: "They are typically brown, grey, or green.",
            lifespan: "They live for 50-150 years in the wild.",
            diet: "They are herbivores, feeding on grasses, leaves, and fruits.",
            dimorphism: "Males often have longer tails and concave plastrons.",
            speciesCount: "49 species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They are known for their slow movement and long lifespan."
        }
        animals.push(["Tortoise", tortoise]);

        var bat = {
            class: "They are mammals.",
            weight: "Adults weigh between 0.1-3.3 pounds depending on the species.",
            geography: "They are found worldwide.",
            biome: "They live in caves, forests, and urban areas.",
            color: "They are typically brown, grey, or black.",
            lifespan: "They live for 5-30 years depending on the species.",
            diet: "They are insectivores or frugivores, feeding on insects or fruits.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "1,400+ species are currently recognized.",
            legsNum: "They have 2 legs.",
            funFact: "They are the only mammals capable of sustained flight."
        }
        animals.push(["Bat", bat]);

        var cardinal = {
            class: "They are birds.",
            weight: "Adults weigh around 1.5-2 ounces.",
            geography: "They are found in North and South America.",
            biome: "They live in woodlands, gardens, and shrublands.",
            color: "Males are bright red, while females are brown with red highlights.",
            lifespan: "They live for 3-15 years in the wild.",
            diet: "They are omnivores, feeding on seeds, fruits, and insects.",
            dimorphism: "Males are more brightly colored than females.",
            speciesCount: "3 species are currently recognized.",
            legsNum: "They have 2 legs.",
            funFact: "They are known for their bright red plumage and melodious songs."
        }
        animals.push(["Cardinal", cardinal]);

        var tuna = {
            class: "They are fish.",
            weight: "Adults weigh between 20-1,500 pounds depending on the species.",
            geography: "They are found in oceans worldwide.",
            biome: "They live in open ocean environments.",
            color: "They are typically dark blue with silver sides.",
            lifespan: "They live for 15-40 years depending on the species.",
            diet: "They are carnivores, feeding on smaller fish and invertebrates.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "15 species are currently recognized.",
            legsNum: "They have no legs.",
            funFact: "They are known for their speed and endurance, able to swim long distances."
        }
        animals.push(["Tuna", tuna]);

        var salmon = {
            class: "They are fish.",
            weight: "Adults weigh between 4-110 pounds depending on the species.",
            geography: "They are found in the North Atlantic and Pacific Oceans.",
            biome: "They live in both freshwater and marine environments.",
            color: "They are typically silver with darker backs, turning red during spawning.",
            lifespan: "They live for 3-8 years depending on the species.",
            diet: "They are carnivores, feeding on smaller fish and invertebrates.",
            dimorphism: "Males develop hooked jaws during spawning.",
            speciesCount: "8 species are currently recognized.",
            legsNum: "They have no legs.",
            funFact: "They are known for their long migrations from the ocean to freshwater streams to spawn."
        }
        animals.push(["Salmon", salmon]);

        var salamander = {
            class: "They are amphibians.",
            weight: "Adults weigh between 0.1-6 pounds depending on the species.",
            geography: "They are found in North America, Europe, and Asia.",
            biome: "They live in forests, grasslands, and wetlands.",
            color: "They are typically black, brown, or brightly colored with spots or stripes.",
            lifespan: "They live for 5-20 years depending on the species.",
            diet: "They are carnivores, feeding on insects, worms, and small invertebrates.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "700+ species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They are known for their ability to regenerate lost limbs and tails."
        }
        animals.push(["Salamander", salamander]);

        var beetle = {
            class: "They are insects.",
            weight: "Adults weigh between 0.001-3.5 ounces depending on the species.",
            geography: "They are found worldwide.",
            biome: "They live in forests, grasslands, and deserts.",
            color: "They come in a wide range of colors and patterns.",
            lifespan: "They live for a few months to several years depending on the species.",
            diet: "They are herbivores, carnivores, or detritivores, feeding on plants, other insects, or decaying matter.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "400,000+ species are currently recognized.",
            legsNum: "They have 6 legs.",
            funFact: "They are the largest group of insects, making up about 40% of all known insect species."
        }
        animals.push(["Beetle", beetle]);

        var butterfly = {
            class: "They are insects.",
            weight: "Adults weigh between 0.002-0.03 ounces depending on the species.",
            geography: "They are found worldwide.",
            biome: "They live in forests, meadows, and gardens.",
            color: "They come in a wide range of colors and patterns.",
            lifespan: "They live for a few weeks to several months depending on the species.",
            diet: "Adults feed on nectar, while larvae feed on leaves.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "17,500+ species are currently recognized.",
            legsNum: "They have 6 legs.",
            funFact: "They undergo complete metamorphosis."
        }
        animals.push(["Butterfly", butterfly]);

        var dragonfly = {
            class: "They are insects.",
            weight: "Adults weigh around 0.02-0.03 ounces.",
            geography: "They are found worldwide.",
            biome: "They live near freshwater bodies like ponds, lakes, and streams.",
            color: "They come in a variety of colors, including blue, green, and red.",
            lifespan: "They live for a few months to several years, depending on the stage of life.",
            diet: "They are carnivores, feeding on insects.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "5,000+ species are currently recognized.",
            legsNum: "They have 6 legs.",
            funFact: "They are known for their agile flight and are capable of hovering in place."
        }
        animals.push(["Dragonfly", dragonfly]);

        var dove = {
            class: "They are birds.",
            weight: "Adults weigh around 4-6 ounces.",
            geography: "They are found worldwide.",
            biome: "They live in woodlands, gardens, and urban areas.",
            color: "They are typically grey, white, or brown.",
            lifespan: "They live for 3-5 years in the wild, longer in captivity.",
            diet: "They are granivores, feeding on seeds and grains.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "300+ species are currently recognized.",
            legsNum: "They have 2 legs.",
            funFact: "They are symbols of peace and love in many cultures."
        }
        animals.push(["Dove", dove]);

        var bull = {
            class: "They are mammals.",
            weight: "Adults weigh between 1,100-2,200 pounds.",
            geography: "They are found worldwide.",
            biome: "They live in grasslands and agricultural areas.",
            color: "They can be a variety of colors, including black, brown, and white.",
            lifespan: "They live for 10-20 years.",
            diet: "They are herbivores, feeding on grass and hay.",
            dimorphism: "Males are larger and have more muscular builds than females.",
            speciesCount: "1 species with various breeds.",
            legsNum: "They have 4 legs.",
            funFact: "They are used in agriculture for breeding and sometimes for draft purposes."
        }
        animals.push(["Bull", bull]);

        var gecko = {
            class: "They are reptiles.",
            weight: "Adults weigh between 0.5-2 ounces depending on the species.",
            geography: "They are found in warm climates worldwide.",
            biome: "They live in forests, deserts, and urban areas.",
            color: "They come in a variety of colors and patterns.",
            lifespan: "They live for 5-20 years depending on the species.",
            diet: "They are insectivores, feeding on insects and small invertebrates.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "1,500+ species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They are known for their ability to climb smooth surfaces due to specialized toe pads."
        }
        animals.push(["Gecko", gecko]);

        var clam = {
            class: "They are mollusks.",
            weight: "Adults weigh between 0.1-550 pounds depending on the species.",
            geography: "They are found in oceans and freshwater bodies worldwide.",
            biome: "They live in marine and freshwater environments.",
            color: "They are typically grey or brown.",
            lifespan: "They live for 1-100+ years depending on the species.",
            diet: "They are filter feeders, feeding on plankton and other small particles.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "15,000+ species are currently recognized.",
            legsNum: "They have no legs.",
            funFact: "They have a two-part shell that they can close tightly for protection."
        }
        animals.push(["Clam", clam]);

        var lemur = {
            class: "They are mammals.",
            weight: "Adults weigh between 2-20 pounds depending on the species.",
            geography: "They are found only in Madagascar.",
            biome: "They live in tropical and subtropical forests.",
            color: "They are typically grey, brown, or black.",
            lifespan: "They live for 15-30 years in the wild.",
            diet: "They are omnivores, feeding on fruits, leaves, and insects.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "100+ species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They are known for their large, reflective eyes and social behavior. They also like to move it move it"
        }
        animals.push(["Lemur", lemur]);

        var iguana = {
            class: "They are reptiles.",
            weight: "Adults weigh between 2-20 pounds depending on the species.",
            geography: "They are found in Central and South America, and the Caribbean.",
            biome: "They live in tropical rainforests and deserts.",
            color: "They are typically green, brown, or grey.",
            lifespan: "They live for 10-20 years in the wild.",
            diet: "They are herbivores, feeding on leaves, fruits, and flowers.",
            dimorphism: "Males are larger and have more pronounced crests and dewlaps.",
            speciesCount: "35 species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They are excellent swimmers and can hold their breath for up to 30 minutes."
        }
        animals.push(["Iguana", iguana]);

        var elk = {
            class: "They are mammals.",
            weight: "Adults weigh between 500-1,100 pounds.",
            geography: "They are found in North America and eastern Asia.",
            biome: "They live in forests and grasslands.",
            color: "They are typically brown with a lighter rump.",
            lifespan: "They live for 10-20 years in the wild.",
            diet: "They are herbivores, feeding on grasses, leaves, and bark.",
            dimorphism: "Males are larger and have antlers.",
            speciesCount: "1 species with several subspecies.",
            legsNum: "They have 4 legs.",
            funFact: "They are known for their bugling calls during the mating season."
        }
        animals.push(["Elk", elk]);

        var moth = {
            class: "They are insects.",
            weight: "Adults weigh between 0.01-0.03 ounces depending on the species.",
            geography: "They are found worldwide.",
            biome: "They live in forests, meadows, and urban areas.",
            color: "They come in a variety of colors and patterns.",
            lifespan: "They live for a few weeks to several months depending on the species.",
            diet: "Adults feed on nectar, while larvae feed on leaves.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "160,000+ species are currently recognized.",
            legsNum: "They have 6 legs.",
            funFact: "They are known for being attracted to light and their nocturnal activity."
        }
        animals.push(["Moth", moth]);

        var vulture = {
            class: "They are birds.",
            weight: "Adults weigh between 3-30 pounds depending on the species.",
            geography: "They are found worldwide except for Australia and Antarctica.",
            biome: "They live in open areas such as savannas and deserts.",
            color: "They are typically brown or black.",
            lifespan: "They live for 10-30 years in the wild.",
            diet: "They are scavengers, feeding on carrion.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "23 species are currently recognized.",
            legsNum: "They have 2 legs.",
            funFact: "They have highly acidic stomachs to digest decaying meat and kill bacteria."
        }
        animals.push(["Vulture", vulture]);

        var kiwi = {
        class: "They are birds.",
        weight: "Adults weigh between 3-9 pounds.",
        geography: "They are found only in New Zealand.",
        biome: "They live in forests, grasslands, and scrublands.",
        color: "They are typically brown or grey.",
        lifespan: "They live for 25-50 years in the wild.",
        diet: "They are omnivores, feeding on insects, fruits, and seeds.",
        dimorphism: "Females are larger than males.",
        speciesCount: "5 species are currently recognized.",
        legsNum: "They have 2 legs.",
        funFact: "They have nostrils at the end of their long beaks, which they use to sniff out food."
    }
    animals.push(["Kiwi", kiwi]);

    var ray = {
        class: "They are fish.",
        weight: "Adults weigh between 2-1,300 pounds depending on the species.",
        geography: "They are found in oceans worldwide.",
        biome: "They live in marine environments, often near the sea floor.",
        color: "They are typically grey, brown, or spotted.",
        lifespan: "They live for 15-25 years depending on the species.",
        diet: "They are carnivores, feeding on mollusks, crustaceans, and small fish.",
        dimorphism: "No sexual dimorphism.",
        speciesCount: "600+ species are currently recognized.",
        legsNum: "They have no legs.",
        funFact: "They have flat bodies with wing-like pectoral fins and some species have a venomous tail spine."
    }
    animals.push(["Ray", ray]);

    var badger = {
            class: "They are mammals.",
            weight: "Adults weigh between 15-30 pounds depending on the species.",
            geography: "They are found in North America, Europe, and Asia.",
            biome: "They live in forests, grasslands, and agricultural areas.",
            color: "They are typically grey or brown with distinctive facial markings.",
            lifespan: "They live for 4-14 years in the wild.",
            diet: "They are omnivores, feeding on small mammals, insects, fruits, and roots.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "8 species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "They are known for their digging abilities and live in burrows called setts."
        }
        animals.push(["Badger", badger]);

        var lizard = {
            class: "They are reptiles.",
            weight: "Adults weigh between 0.1-300 pounds depending on the species.",
            geography: "They are found worldwide.",
            biome: "They live in forests, deserts, grasslands, and urban areas.",
            color: "They come in a variety of colors and patterns.",
            lifespan: "They live for 1-30 years depending on the species.",
            diet: "They are omnivores, feeding on insects, small animals, and plants.",
            dimorphism: "No sexual dimorphism.",
            speciesCount: "6,000+ species are currently recognized.",
            legsNum: "They have 4 legs.",
            funFact: "Some species can detach their tails to escape predators."
        }
        animals.push(["Lizard", lizard]);

        var rooster = {
            class: "They are birds.",
            weight: "Adults weigh between 5-8 pounds.",
            geography: "They are found worldwide, often in domestic settings.",
            biome: "They live in farms, backyards, and rural areas.",
            color: "They come in a variety of colors, often with vibrant plumage.",
            lifespan: "They live for 5-10 years.",
            diet: "They are omnivores, feeding on seeds, insects, and small animals.",
            dimorphism: "All are males.",
            speciesCount: "1 species with various breeds.",
            legsNum: "They have 2 legs.",
            funFact: "They are known for their crowing, especially at dawn."
        }
        animals.push(["Rooster", rooster]);
    }
